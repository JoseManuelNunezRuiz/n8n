...
import { T as TemplateList } from "./TemplateList-BHbHvx-_.js";
import { T as TemplatesView } from "./TemplatesView-BTxutjLU.js";
import { d as defineComponent, bk as useTemplatesStore, ae as useNodeTypesStore, a3 as useRoute, b as useRouter, ay as useDocumentTitle, r as ref, x as computed, a8 as watch, o as onMounted, e as createBlock, g as openBlock, b_ as createSlots, w as withCtx, j as createBaseVNode, n as normalizeClass, h as createElementBlock, f as createCommentVNode, i as createVNode, k as unref, eK as isFullTemplatesCollection, eL as N8nMarkdown, c as useI18n, m as N8nHeading, l as createTextVNode, t as toDisplayString, p as N8nText, dI as N8nLoading, V as VIEWS, al as useTelemetry, bs as useExternalHooks, _ as _export_sfc } from "./index-C2iJCVYf.js";
        ...
        header: withCtx(() => [
          !notFoundError.value ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              collection.value && collection.value.name ? (openBlock(), createBlock(unref(N8nHeading), {
                key: 0,
                tag: "h1",
                size: "2xlarge"
              }, {
              ...
              collection.value && collection.value.name ? (openBlock(), createBlock(unref(N8nText), {
                key: 1,
                color: "text-base",
                size: "small"
              }, {
...
const wrapper = "_wrapper_1m9iq_123";
const notFound = "_notFound_1m9iq_133";
const title = "_title_1m9iq_137";
const button = "_button_1m9iq_141";
const mainContent = "_mainContent_1m9iq_145";
const markdown = "_markdown_1m9iq_156";
const details = "_details_1m9iq_160";
const style0 = {
  wrapper,
  notFound,
  title,
