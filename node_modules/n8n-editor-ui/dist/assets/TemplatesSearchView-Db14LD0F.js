import { d as defineComponent, e as createBlock, g as openBlock, k as unref, s as N8nCard, K as mergeProps, b_ as createSlots, w as withCtx, j as createBaseVNode, t as toDisplayString, n as normalizeClass, Y as renderSlot, i as createVNode, dI as N8nLoading, _ as _export_sfc, ap as normalizeStyle, b4 as withDirectives, p as N8nText, l as createTextVNode, c as useI18n, b5 as vShow, eX as orderBy, eY as requireDebounce, eZ as requireIsObject, dS as getDefaultExportFromCjs, h as createElementBlock, f as createCommentVNode, F as Fragment, A as renderList, r as ref, a8 as watch, o as onMounted, Z as nextTick, b3 as onBeforeMount, N as N8nIcon, x as computed, dH as ElCheckbox, P as useDebounce, a as useToast, ay as useDocumentTitle, v as useSettingsStore, bk as useTemplatesStore, u as useUsersStore, a3 as useRoute, b as useRouter, di as onBeforeRouteLeave, c0 as resolveDirective, cT as N8nInput, m as N8nHeading, q as N8nButton, e_ as CREATOR_HUB_URL, V as VIEWS, al as useTelemetry } from "./index-C2iJCVYf.js";
import { N as NodeList, T as TemplateList } from "./TemplateList-BHbHvx-_.js";
import { T as TemplatesView } from "./TemplatesView-BTxutjLU.js";
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(N8nCard), mergeProps({
...
const card = "_card_1goyo_123";
const title$1 = "_title_1goyo_139";
const style0$3 = {
  card,
  title: title$1
};
      ...
      return openBlock(), createBlock(Card, {
        ...
        footer: withCtx(() => [
          createBaseVNode("span", null, [
            withDirectives(createVNode(unref(N8nText), {
              size: "small",
              color: "text-light"
            }, {
              default: withCtx(() => [
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        withDirectives(createBaseVNode("button", {
          ...
          createVNode(unref(N8nIcon), { icon: "chevron-left" })
        ], 2), [
        ...
        withDirectives(createBaseVNode("button", {
          ...
          createVNode(unref(N8nIcon), { icon: "chevron-right" })
        ], 2), [
...
const container = "_container_103nw_123";
const button$1 = "_button_103nw_127";
const leftButton = "_leftButton_103nw_148 _button_103nw_127";
const rightButton = "_rightButton_103nw_157 _button_103nw_127";
const style0$2 = {
  container,
  button: button$1,
  leftButton,
...
const title = "_title_jr0i7_123";
const categories = "_categories_jr0i7_128";
const item = "_item_jr0i7_133";
const button = "_button_jr0i7_140";
const style0$1 = {
  title,
  categories,
  item,
...
const wrapper = "_wrapper_xumc9_123";
const contentWrapper = "_contentWrapper_xumc9_128";
const filters = "_filters_xumc9_138";
const search = "_search_xumc9_144";
const header = "_header_xumc9_156";
const style0 = {
  wrapper,
  contentWrapper,
  filters,
