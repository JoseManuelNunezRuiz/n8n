import { d as defineComponent, x as computed, eM as filterTemplateNodes, h as createElementBlock, g as openBlock, n as normalizeClass, f as createCommentVNode, F as Fragment, A as renderList, i as createVNode, c8 as NodeIcon, t as toDisplayString, _ as _export_sfc, k as unref, dI as N8nLoading, w as withCtx, l as createTextVNode, m as N8nHeading, e as createBlock, N as N8nIcon, eP as abbreviateNumber, p as N8nText, eO as _sfc_main$3, c as useI18n, q as N8nButton, B as withModifiers, r as ref, o as onMounted, X as onBeforeUnmount, j as createBaseVNode } from "./index-C2iJCVYf.js";
...
const list = "_list_4d2c7_123";
const container = "_container_4d2c7_131";
const sm = "_sm_4d2c7_136";
const md = "_md_4d2c7_140";
const button$1 = "_button_4d2c7_144";
const buttonSm = "_buttonSm_4d2c7_158";
const buttonMd = "_buttonMd_4d2c7_165";
const style0$2 = {
  list,
  container,
  sm,
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.loading ? (openBlock(), createElementBlock("div", {
          ...
          !_ctx.simpleView ? (openBlock(), createElementBlock("div", {
            ...
            _ctx.workflow.user ? (openBlock(), createBlock(unref(N8nText), {
              key: 3,
              size: "small",
              color: "text-light"
            }, {
        ...
        _ctx.useWorkflowButton ? (openBlock(), createElementBlock("div", {
          ...
          _ctx.useWorkflowButton ? (openBlock(), createBlock(unref(N8nButton), {
            key: 0,
            outline: "",
            label: "Use workflow",
...
const nodes$1 = "_nodes_9we9y_123";
const icon = "_icon_9we9y_130";
const card = "_card_9we9y_134";
const hideOnHover = "_hideOnHover_9we9y_146";
const buttonContainer = "_buttonContainer_9we9y_149";
const loaded = "_loaded_9we9y_160";
const first = "_first_9we9y_164";
const last = "_last_9we9y_170";
const content = "_content_9we9y_175";
const line = "_line_9we9y_180";
const loading = "_loading_9we9y_186";
const nodesContainer = "_nodesContainer_9we9y_191";
const style0$1 = {
  nodes: nodes$1,
  icon,
  card,
...
const header = "_header_ff02l_123";
const workflowButton = "_workflowButton_ff02l_127";
const button = "_button_ff02l_127";
const nodes = "_nodes_ff02l_130";
const style0 = {
  header,
  workflowButton,
  button,
