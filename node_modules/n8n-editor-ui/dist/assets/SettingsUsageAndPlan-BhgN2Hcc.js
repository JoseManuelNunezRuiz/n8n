import { d as defineComponent, f4 as useUsageStore, a3 as useRoute, b as useRouter, Q as useUIStore, u as useUsersStore, a as useToast, ay as useDocumentTitle, aB as usePageRedirectionHelper, r as ref, x as computed, aE as hasPermission, aC as getResourcePermissions, o as onMounted, f5 as i18n, h as createElementBlock, g as openBlock, i as createVNode, f as createCommentVNode, w as withCtx, l as createTextVNode, t as toDisplayString, k as unref, m as N8nHeading, e as createBlock, j as createBaseVNode, ac as I18nT, n as normalizeClass, aa as N8nTooltip, aL as N8nBadge, q as N8nButton, e5 as N8nNotice, p as N8nText, ap as normalizeStyle, cK as InfoTip, B as withModifiers, cT as N8nInput, f6 as ElDialog, f7 as COMMUNITY_PLUS_ENROLLMENT_MODAL, f8 as telemetry, _ as _export_sfc } from "./index-C2iJCVYf.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        !unref(usageStore).isLoading ? (openBlock(), createElementBlock("div", _hoisted_2, [
          ...
          isCommunity.value && canUserRegisterCommunityPlus.value ? (openBlock(), createBlock(unref(N8nNotice), {
            key: 0,
            class: "mt-0",
            theme: "warning"
          }, {
          ...
          createBaseVNode("div", {
            ...
            canUserActivateLicense.value ? (openBlock(), createBlock(unref(N8nButton), {
              key: 0,
            ...
            unref(usageStore).managementToken ? (openBlock(), createBlock(unref(N8nButton), {
              key: 1,
              size: "large",
          ...
          createVNode(unref(ElDialog), {
            ...
            footer: withCtx(() => [
              ...
              createVNode(unref(N8nButton), { onClick: onLicenseActivation }, {
                default: withCtx(() => [
...
const center = "_center_g33cs_123";
const actionBox = "_actionBox_g33cs_127";
const spacedFlex = "_spacedFlex_g33cs_131";
const title = "_title_g33cs_137";
const quota = "_quota_g33cs_143";
const count = "_count_g33cs_155";
const buttons = "_buttons_g33cs_160";
const chart = "_chart_g33cs_176";
const chartLine = "_chartLine_g33cs_183";
const chartBar = "_chartBar_g33cs_193";
const titleTooltip = "_titleTooltip_g33cs_207";
const style0 = {
  center,
  actionBox,
  spacedFlex,
...
const SettingsUsageAndPlan = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-38c96cc4"]]);
export {
