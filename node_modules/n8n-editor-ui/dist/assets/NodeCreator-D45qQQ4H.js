import { d as defineComponent, c$ as reactive, o as onMounted, bs as useExternalHooks, X as onBeforeUnmount, bR as toRefs, h as createElementBlock, g as openBlock, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, i as createVNode, k as unref, N as N8nIcon, _ as _export_sfc, jd as REGULAR_NODE_CREATOR_VIEW, F as Fragment, Y as renderSlot, je as useViewStacks, r as ref, x as computed, jf as useInstalledCommunityPackage, ae as useNodeTypesStore, u as useUsersStore, e as createBlock, p as N8nText, w as withCtx, l as createTextVNode, t as toDisplayString, jg as _sfc_main$b, aa as N8nTooltip, f5 as i18n, jh as captureException, ji as useKeyboardNavigation, iB as useActions, d0 as useNodeCreatorStore, bm as useCalloutHelpers, jj as CUSTOM_API_CALL_KEY, jk as TRIGGER_NODE_CREATOR_VIEW, jl as isNodePreviewKey, jm as OPEN_AI_NODE_TYPE, jn as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, al as useTelemetry, jo as getActiveViewCallouts, c0 as resolveDirective, jp as ItemsRenderer, b_ as createSlots, jq as withMemo, jr as CategorizedItemsRenderer, c as useI18n, z as N8nCallout, b4 as withDirectives, cK as InfoTip, B as withModifiers, js as CommunityNodeFooter, jt as HTTP_REQUEST_NODE_TYPE, gi as createStaticVNode, C as N8nLink, ju as REQUEST_NODE_FORM_URL, jv as filterAndSearchNodes, jw as getRootSearchCallouts, iW as WEBHOOK_NODE_TYPE, jx as PRE_BUILT_AGENTS_COLLECTION, jy as camelCase, jz as shouldShowCommunityNodeDetails, fr as isCommunityPackageName, jA as prepareCommunityNodeDetailsViewStack, i$ as getNodeIconSource, jB as transformNodeType, jC as AINodesView, jD as AIView, jE as RegularView, jF as TriggerView, jG as flattenCreateElements, jH as HITL_SUBCATEGORY, jI as getHumanInTheLoopActions, jJ as AI_OTHERS_NODE_CREATOR_VIEW, jK as AI_NODE_CREATOR_VIEW, er as useCommunityNodesStore, a as useToast, c8 as NodeIcon, jL as OfficialIcon, q as N8nButton, d1 as useCredentialsStore, jM as removePreviewToken, P as useDebounce, bh as onUnmounted, a8 as watch, e5 as N8nNotice, bS as normalizeProps, K as mergeProps, fF as Transition, jN as AI_EVALUATION, jO as AI_UNCATEGORIZED_CATEGORY, Q as useUIStore, iA as useChatPanelStore, bt as onClickOutside, ab as _sfc_main$c, ap as normalizeStyle, jP as SlideTransition, dB as DRAG_EVENT_DATA_KEY, jQ as useActionsGenerator } from "./index-C2iJCVYf.js";
...
const searchContainer = "_searchContainer_neuh0_123";
const prefix = "_prefix_neuh0_139";
const active$1 = "_active_neuh0_144";
const text = "_text_neuh0_148";
const suffix = "_suffix_neuh0_164";
const clear = "_clear_neuh0_170";
const clickable = "_clickable_neuh0_183";
const style0$8 = {
  searchContainer,
  prefix,
  active: active$1,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function fetchPackageInfo(packageName2) {
      ...
      const url = `https://registry.npmjs.org/${packageName2}`;
      try {
        const response = await fetch(url);
        if (!response.ok) {
          captureException(new Error("Could not get metadata for package"), { extra: { packageName: packageName2 } });
          return;
        }
        ...
        const downloadsUrl = `https://api.npmjs.org/downloads/range/2022-01-01:${today}/${packageName2}`;
        const downloadsResponse = await fetch(downloadsUrl);
        if (!downloadsResponse.ok) {
          captureException(new Error("Could not get downloads for package"), {
            extra: { packageName: packageName2 }
          });
          return;
        }
        ...
        captureException(error, { extra: { packageName: packageName2 } });
      }
    }
    onMounted(async () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(isUpdateCheckAvailable) && unref(installedPackage)?.updateAvailable ? (openBlock(), createBlock(_sfc_main$b, {
          key: 0,
...
const container$3 = "_container_19qm2_123";
const nodeIcon$2 = "_nodeIcon_19qm2_132";
const description = "_description_19qm2_137";
const separator = "_separator_19qm2_141";
const info$1 = "_info_19qm2_147";
const tooltipIcon = "_tooltipIcon_19qm2_162";
const contactOwnerHint = "_contactOwnerHint_19qm2_168";
const style0$7 = {
            ...
            fn: withCtx(() => [
              withMemo([search.value], () => createVNode(CategorizedItemsRenderer, {
                ...
                hasNoTriggerActions.value ? {
                  name: "empty",
                  fn: withCtx(() => [
                    hasNoTriggerActions.value ? (openBlock(), createBlock(unref(N8nCallout), {
                      key: 0,
                      theme: "info",
                      iconless: "",
                      slim: "",
          ...
          !isTriggerRootView.value || parsedActionActionsBaseline.value.length !== 0 ? {
            ...
            fn: withCtx(() => [
              withMemo([search.value], () => createVNode(CategorizedItemsRenderer, {
                ...
                empty: withCtx(() => [
                  !search.value ? (openBlock(), createBlock(unref(InfoTip), {
                    key: 0,
                    theme: "info",
                    type: "note",
                ...
                default: withCtx(() => [
                  !unref(userActivated) && isTriggerRootView.value ? (openBlock(), createBlock(unref(N8nCallout), {
                    key: 0,
                    theme: "info",
                    iconless: "",
                    slim: "",
...
const container$2 = "_container_12w99_123";
const containerPaddingBottom = "_containerPaddingBottom_12w99_129";
const communityNodeFooter = "_communityNodeFooter_12w99_133";
const resetSearch = "_resetSearch_12w99_137";
const actionsEmpty = "_actionsEmpty_12w99_151";
const apiHint = "_apiHint_12w99_159";
const style0$6 = {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.rootView === unref(REGULAR_NODE_CREATOR_VIEW) || _ctx.rootView === unref(TRIGGER_NODE_CREATOR_VIEW) ? (openBlock(), createElementBlock("div", {
            ...
            _ctx.rootView === unref(REGULAR_NODE_CREATOR_VIEW) ? (openBlock(), createBlock(unref(N8nLink), {
              key: 0,
            ...
            _ctx.rootView === unref(TRIGGER_NODE_CREATOR_VIEW) ? (openBlock(), createBlock(unref(N8nLink), {
              key: 1,
        ...
        _ctx.showRequest ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", null, [
            createVNode(unref(N8nLink), { to: unref(REQUEST_NODE_FORM_URL) }, {
              default: withCtx(() => [
...
const noResults = "_noResults_1w8hr_123";
const title$2 = "_title_1w8hr_136";
const action = "_action_1w8hr_145";
const request = "_request_1w8hr_146";
const icon = "_icon_1w8hr_162";
const external = "_external_1w8hr_168";
const style0$5 = {
  noResults,
  title: title$2,
  action,
      ...
      return unref(communityNodeDetails) ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            unref(communityNodeDetails).nodeIcon ? (openBlock(), createBlock(NodeIcon, {
              key: 0,
            ...
            unref(communityNodeDetails).official ? (openBlock(), createBlock(unref(N8nTooltip), {
              key: 1,
              placement: "bottom",
              "show-after": 500
            }, {
          ...
          createBaseVNode("div", null, [
            unref(communityNodeDetails).installed ? (openBlock(), createElementBlock("div", {
              ...
              !unref(communityNodeDetails).official ? (openBlock(), createBlock(unref(N8nIcon), {
                key: 0,
            ...
            isOwner.value && !unref(communityNodeDetails).installed ? (openBlock(), createBlock(unref(N8nButton), {
              key: 1,
...
const container$1 = "_container_3ir84_123";
const header$1 = "_header_3ir84_131";
const title$1 = "_title_3ir84_138";
const nodeIcon$1 = "_nodeIcon_3ir84_146";
const installedIcon = "_installedIcon_3ir84_151";
const officialIcon = "_officialIcon_3ir84_157";
const installed = "_installed_3ir84_151";
const style0$3 = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(N8nLink), {
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(N8nIcon), { icon: "external-link" })
        ]),
        _: 1
      }, 8, ["class", "title"]);
    };
...
const container = "_container_1ms6i_123";
const style0$2 = {
  container
};
const cssModules$2 = {
        ...
        default: withCtx(() => [
          (openBlock(), createElementBlock("aside", {
            ...
            createBaseVNode("div", {
              ...
              activeViewStack.value.info && !activeViewStack.value.search ? (openBlock(), createBlock(unref(N8nNotice), {
                key: 0,
                class: normalizeClass(_ctx.$style.info),
...
const info = "_info_dpb67_145";
const backButton = "_backButton_dpb67_149";
const backButtonIcon = "_backButtonIcon_dpb67_156";
const nodeIcon = "_nodeIcon_dpb67_161";
const renderedItems = "_renderedItems_dpb67_167";
const searchBar = "_searchBar_dpb67_179";
const nodesListPanel = "_nodesListPanel_dpb67_183";
const footer = "_footer_dpb67_201";
const top = "_top_dpb67_212";
const header = "_header_dpb67_217";
const hasBg = "_hasBg_dpb67_223";
const title = "_title_dpb67_228";
const subtitle = "_subtitle_dpb67_239";
const offsetSubtitle = "_offsetSubtitle_dpb67_247";
const style0$1 = {
  info,
  backButton,
  backButtonIcon,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        _ctx.active ? (openBlock(), createBlock(unref(_sfc_main$c), {
          key: 0,
...
const nodeCreator = "_nodeCreator_ke2v0_127";
const nodeCreatorScrim = "_nodeCreatorScrim_ke2v0_139";
const active = "_active_ke2v0_151";
const close = "_close_ke2v0_155";
const style0 = {
  nodeCreator,
  nodeCreatorScrim,
  active,
