import { a0 as defineStore, r as ref, bk as useTemplatesStore, ae as useNodeTypesStore, d1 as useCredentialsStore, au as useRootStore, a2 as useWorkflowsStore, x as computed, eQ as useCredentialSetupState, bs as useExternalHooks, al as useTelemetry, V as VIEWS, eR as tryToParseNumber, d as defineComponent, a3 as useRoute, b as useRouter, a8 as watch, o as onMounted, e as createBlock, g as openBlock, w as withCtx, j as createBaseVNode, n as normalizeClass, eS as AppsRequiringCredsNotice, k as unref, dI as N8nLoading, h as createElementBlock, F as Fragment, A as renderList, eT as SetupTemplateFormStep, i as createVNode, C as N8nLink, l as createTextVNode, t as toDisplayString, c as useI18n, aa as N8nTooltip, q as N8nButton, m as N8nHeading, _ as _export_sfc } from "./index-C2iJCVYf.js";
import { c as createWorkflowFromTemplate } from "./templateActions-CqLHZUrv.js";
      ...
      return openBlock(), createBlock(TemplatesView, { "go-back-enabled": true }, {
        header: withCtx(() => [
          isReady.value ? (openBlock(), createBlock(unref(N8nHeading), {
            ...
            _: 1
          })) : (openBlock(), createBlock(unref(N8nLoading), {
            key: 1,
            variant: "h1"
          }))
        ]),
        content: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              }, null, 8, ["app-credentials"])) : (openBlock(), createBlock(unref(N8nLoading), {
                key: 1,
                variant: "p"
              }))
            ], 2),
            ...
            createBaseVNode("div", {
              ...
              isReady.value ? (openBlock(), createBlock(unref(N8nTooltip), {
                key: 0,
                ...
                createVNode(unref(N8nLoading), { variant: "button" })
              ]))
            ], 2)
          ], 2)
        ]),
...
const grid = "_grid_e7pvm_123";
const notice = "_notice_e7pvm_131";
const appCredentialsContainer = "_appCredentialsContainer_e7pvm_135";
const appCredential = "_appCredential_e7pvm_135";
const actions = "_actions_e7pvm_146";
const style0 = {
  grid,
  notice,
