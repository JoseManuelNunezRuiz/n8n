import { d as defineComponent, h as createElementBlock, g as openBlock, n as normalizeClass, j as createBaseVNode, i as createVNode, w as withCtx, l as createTextVNode, t as toDisplayString, k as unref, m as N8nHeading, Y as renderSlot, _ as _export_sfc, b as useRouter, bk as useTemplatesStore, x as computed, e as createBlock, f as createCommentVNode, dI as N8nLoading, F as Fragment, A as renderList, c8 as NodeIcon, eM as filterTemplateNodes, eK as isFullTemplatesCollection, c as useI18n, eN as isTemplatesWorkflow, p as N8nText, eO as _sfc_main$2, eP as abbreviateNumber } from "./index-C2iJCVYf.js";
...
const block = "_block_88jt1_123";
const header = "_header_88jt1_127";
const content = "_content_88jt1_132";
const style0$1 = {
  block,
  header,
  content
        ...
        !_ctx.loading && _ctx.template ? (openBlock(), createBlock(TemplateDetailsBlock, {
          ...
          default: withCtx(() => [
            createBaseVNode("div", {
              ...
              unref(isTemplatesWorkflow)(_ctx.template) ? (openBlock(), createBlock(unref(N8nText), {
                key: 0,
                size: "small",
                color: "text-base"
              }, {
            ...
            createBaseVNode("div", {
              ...
              unref(isTemplatesWorkflow)(_ctx.template) && _ctx.template.totalViews !== 0 ? (openBlock(), createBlock(unref(N8nText), {
                key: 0,
                size: "small",
                color: "text-base"
              }, {
...
const icons = "_icons_18wvw_123";
const icon = "_icon_18wvw_123";
const text = "_text_18wvw_134";
const style0 = {
  icons,
  icon,
  text
...
const TemplateDetails = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules]]);
export {
