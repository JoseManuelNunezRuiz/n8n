import { d as defineComponent, r as ref, x as computed, e as createBlock, g as openBlock, b_ as createSlots, w as withCtx, Y as renderSlot, h as createElementBlock, F as Fragment, A as renderList, k as unref, e7 as _sfc_main$8, n as normalizeClass, i as createVNode, J as N8nUserInfo, K as mergeProps, D as useI18n, e6 as N8nSelect, _ as _export_sfc, eg as mergeModels, eh as useModel, bt as onClickOutside, j as createBaseVNode, f as createCommentVNode, aa as N8nTooltip, ab as _sfc_main$9, q as N8nButton, l as createTextVNode, t as toDisplayString, h5 as N8nTabs, N as N8nIcon, c as useI18n$1, p as N8nText, ed as ElRadio, gq as ProjectSharing, e3 as N8nInputLabel, cT as N8nInput, B as withModifiers, f6 as ElDialog, aB as usePageRedirectionHelper, ac as I18nT, a8 as watch, hk as isProjectRole, aO as N8nActionDropdown, ee as N8nActionToggle, ei as N8nDataTableServer, bS as normalizeProps, bT as guardReactiveProps, u as useUsersStore, av as useProjectsStore, hl as useRolesStore, b9 as useCloudPlanStore, a as useToast, b as useRouter, ay as useDocumentTitle, b3 as onBeforeMount, o as onMounted, f0 as N8nFormInput, dN as deepCopy, al as useTelemetry, Z as nextTick, fA as isIconOrEmoji, V as VIEWS, en as useDebounceFn } from "./index-C2iJCVYf.js";
...
const itemContainer = "_itemContainer_1bayv_123";
const limitPopperWidth = "_limitPopperWidth_1bayv_128";
const style0$4 = {
  itemContainer,
  limitPopperWidth
};
...
const container = "_container_91t0n_123";
const popup = "_popup_91t0n_131";
const tabs = "_tabs_91t0n_144";
const content = "_content_91t0n_148";
const icon = "_icon_91t0n_154";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElDialog), {
        ...
        default: withCtx(() => [
          !hasMovableResources.value ? (openBlock(), createBlock(unref(N8nText), {
            key: 0,
            color: "text-base"
          }, {
            default: withCtx(() => [
...
const operation = "_operation_12mti_123";
const style0$2 = {
  operation
};
const cssModules$2 = {
...
const roleLabel = "_roleLabel_3ta9s_123";
const radioLabel = "_radioLabel_3ta9s_133";
const style0$1 = {
  roleLabel,
  radioLabel
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return props.actions.length > 0 ? (openBlock(), createBlock(unref(N8nActionToggle), {
        key: 0,
        placement: "bottom",
  ...
  setup(__props, { emit: __emit }) {
    ...
    const roleActions = computed(() => [
      ...props.projectRoles.map((role) => ({
        ...
        badgeProps: !role.licensed ? { theme: "warning", bold: true } : void 0
      }))
    ]);
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("form", {
          ...
          createBaseVNode("fieldset", null, [
            ...
            createVNode(unref(N8nUserSelect), {
              id: "projectMembers",
              ...
              prefix: withCtx(() => [
                createVNode(unref(N8nIcon), { icon: "search" })
              ]),
              _: 1
...
const projectSettings = "_projectSettings_1fs0u_123";
const header = "_header_1fs0u_147";
const upgrade = "_upgrade_1fs0u_153";
const buttons = "_buttons_1fs0u_157";
const membersTableContainer = "_membersTableContainer_1fs0u_163";
const search = "_search_1fs0u_167";
const projectName = "_projectName_1fs0u_172";
const projectNameInput = "_projectNameInput_1fs0u_177";
const projectDescriptionInput = "_projectDescriptionInput_1fs0u_181";
const userSelect = "_userSelect_1fs0u_182";
const style0 = {
  projectSettings,
  header,
  upgrade,
