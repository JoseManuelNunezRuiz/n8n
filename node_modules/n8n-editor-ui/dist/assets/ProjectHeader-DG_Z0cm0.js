import { d as defineComponent, a3 as useRoute, bn as usePostHog, av as useProjectsStore, x as computed, bp as PROJECT_VARIABLES_EXPERIMENT, r as ref, aG as ProjectTypes, V as VIEWS, c as useI18n, a8 as watch, e as createBlock, g as openBlock, k as unref, h5 as N8nTabs, aH as useTemplateRef, h as createElementBlock, n as normalizeClass, Y as renderSlot, i as createVNode, ee as N8nActionToggle, w as withCtx, ab as _sfc_main$4, _ as _export_sfc, a as useToast, af as useSourceControlStore, aw as useFoldersStore, aC as getResourcePermissions, f as createCommentVNode, q as N8nButton, l as createTextVNode, t as toDisplayString, b as useRouter, v as useSettingsStore, Q as useUIStore, fA as isIconOrEmoji, h6 as useElementSize, h7 as useResizeObserver, j as createBaseVNode, fB as ProjectIcon, m as N8nHeading, p as N8nText, K as mergeProps, aa as N8nTooltip, h8 as PROJECT_DATA_TABLES } from "./index-C2iJCVYf.js";
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              projectName.value ? (openBlock(), createBlock(unref(N8nHeading), {
                key: 0,
                bold: "",
                tag: "h2",
                size: "xlarge",
              ...
              sectionDescription.value ? (openBlock(), createBlock(unref(N8nText), {
                key: 1,
                color: "text-light",
                ...
                projectDescriptionTruncated.value ? (openBlock(), createElementBlock("div", {
                  ...
                  createVNode(unref(N8nText), { color: "text-light" }, {
                    default: withCtx(() => [
...
const projectHeader = "_projectHeader_ckjzo_123";
const projectDetails = "_projectDetails_ckjzo_131";
const actions = "_actions_ckjzo_136";
const projectDescriptionWrapper = "_projectDescriptionWrapper_ckjzo_140";
const tooltip = "_tooltip_ckjzo_144";
const headerActions = "_headerActions_ckjzo_167";
const style0 = {
  projectHeader,
  projectDetails,
  actions,
