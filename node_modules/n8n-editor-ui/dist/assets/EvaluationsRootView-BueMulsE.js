import { d as defineComponent, Q as useUIStore, e as createBlock, g as openBlock, k as unref, dW as N8nActionBox, c as useI18n, f7 as COMMUNITY_PLUS_ENROLLMENT_MODAL, h as createElementBlock, n as normalizeClass, N as N8nIcon, F as Fragment, l as createTextVNode, t as toDisplayString, _ as _export_sfc, i as createVNode, j as createBaseVNode, f as createCommentVNode, Y as renderSlot, p as N8nText, w as withCtx, aL as N8nBadge, b as useRouter, a2 as useWorkflowsStore, ad as useEvaluationStore, f4 as useUsageStore, aB as usePageRedirectionHelper, x as computed, r as ref, q as N8nButton, z as N8nCallout, ac as I18nT, a4 as PLACEHOLDER_EMPTY_WORKFLOW_ID, V as VIEWS, ae as useNodeTypesStore, a as useToast, af as useSourceControlStore, bM as useCanvasOperations, f1 as useAsyncState, a8 as watch, a9 as resolveComponent, C as N8nLink, ai as EVALUATIONS_DOCS_URL, al as useTelemetry } from "./index-C2iJCVYf.js";
...
const stepIndicator = "_stepIndicator_4qh21_123";
const active = "_active_4qh21_137";
const completed = "_completed_4qh21_141";
const inactive = "_inactive_4qh21_146";
const style0$3 = {
  stepIndicator,
  active,
  completed,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.isOptional ? (openBlock(), createBlock(unref(N8nBadge), {
          key: 0,
          style: { "background-color": "var(--color--background)", "border": "none" }
        }, {
          default: withCtx(() => [
...
const stepHeader = "_stepHeader_cqtb0_123";
const style0$2 = {
  stepHeader
};
const cssModules$2 = {
...
const container = "_container_7v9ik_123";
const steps = "_steps_7v9ik_127";
const step = "_step_7v9ik_127";
const stepContent = "_stepContent_7v9ik_137";
const slideDown = "_slideDown_7v9ik_1";
const bulletPoints = "_bulletPoints_7v9ik_142";
const actionButton = "_actionButton_7v9ik_149";
const actionButtonInline = "_actionButtonInline_7v9ik_158";
const quotaNote = "_quotaNote_7v9ik_162";
const style0$1 = {
  container,
  steps,
  step,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        ], 2)) : unref(isReady) ? (openBlock(), createBlock(_component_RouterView, { key: 1 })) : createCommentVNode("", true)
      ], 2);
    };
  }
});
const evaluationsView = "_evaluationsView_3y4a8_123";
const setupContent = "_setupContent_3y4a8_130";
const description = "_description_3y4a8_139";
const config = "_config_3y4a8_144";
const setupDescription = "_setupDescription_3y4a8_150";
const style0 = {
  evaluationsView,
  setupContent,
  description,
