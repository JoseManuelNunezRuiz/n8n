import { d as defineComponent, av as useProjectsStore, aw as useFoldersStore, r as ref, x as computed, c as useI18n, aG as ProjectTypes, a8 as watch, X as onBeforeUnmount, h as createElementBlock, g as openBlock, e as createBlock, f as createCommentVNode, k as unref, b_ as createSlots, w as withCtx, Y as renderSlot, i as createVNode, n as normalizeClass, ee as N8nActionToggle, _ as _export_sfc, l as createTextVNode, j as createBaseVNode, t as toDisplayString, a as useToast, fs as useWorkflowActivate, Q as useUIStore, aA as useWorkflowHelpers, a2 as useWorkflowsStore, d1 as useCredentialsStore, ft as getActivatableTriggerNodes, fu as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, a4 as PLACEHOLDER_EMPTY_WORKFLOW_ID, c0 as resolveDirective, p as N8nText, b4 as withDirectives, ek as ElSwitch, aa as N8nTooltip, N as N8nIcon, fv as OPEN_AI_API_CREDENTIAL_TYPE, fw as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, aY as h } from "./index-C2iJCVYf.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const fetchHiddenBreadCrumbsItems = async () => {
      if (!projectName.value || !props.currentFolder?.parentFolder || isSharedContext.value || !currentProject.value) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        visibleBreadcrumbsItems.value.length ? (openBlock(), createBlock(unref(Breadcrumbs), {
          key: 0,
        ...
        ]), 1032, ["drag-active", "items", "path-truncated", "hidden-items", "hidden-items-trigger"])) : currentProject.value || isSharedContext.value ? (openBlock(), createElementBlock("div", {
          key: 1,
          ...
          createVNode(ProjectBreadcrumb, {
            ...
            onProjectDrop,
            onProjectHover
          }, null, 8, ["current-project", "is-shared", "is-dragging"]),
          renderSlot(_ctx.$slots, "append")
        ], 2)) : (openBlock(), createElementBlock("div", _hoisted_1$1, [
          renderSlot(_ctx.$slots, "append")
        ])),
        visibleBreadcrumbsItems.value && _ctx.actions?.length ? (openBlock(), createBlock(unref(N8nActionToggle), {
          key: 3,
...
const container = "_container_1hwuc_123";
const style0$1 = {
  container,
...
const FolderBreadcrumbs = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1]]);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          ...
          _ctx.workflowActive ? (openBlock(), createBlock(unref(N8nText), {
            key: 0,
            ...
            _: 1
          }, 8, ["color"])) : (openBlock(), createBlock(unref(N8nText), {
            key: 1,
            color: "text-base",
            size: "small",
            bold: ""
        ...
        createVNode(unref(N8nTooltip), {
          ...
          default: withCtx(() => [
            withDirectives(createVNode(unref(ElSwitch), {
        ...
        couldNotBeStarted.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
          createVNode(unref(N8nTooltip), { placement: "top" }, {
            content: withCtx(() => [
...
const activeStatusText = "_activeStatusText_1xmgg_123";
const style0 = {
  activeStatusText
};
const cssModules = {
...
const WorkflowActivator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__cssModules", cssModules], ["__scopeId", "data-v-015a5b6b"]]);
export {
  FolderBreadcrumbs as F,
