import { d as defineComponent, h as createElementBlock, g as openBlock, j as createBaseVNode, n as normalizeClass, e as createBlock, f as createCommentVNode, c8 as NodeIcon, i as createVNode, k as unref, aI as InlineRename, c as useI18n, C as N8nLink, w as withCtx, p as N8nText, l as createTextVNode, t as toDisplayString, N as N8nIcon, aa as N8nTooltip, ab as _sfc_main$3, _ as _export_sfc, r as ref, x as computed, iY as LOCAL_STORAGE_NDV_PANEL_WIDTH, iZ as toValue, h6 as useElementSize, a8 as watch, cl as toRef, dd as jsonParse, h2 as Draggable, a_ as useNDVStore, bG as useNodeHelpers, ev as storeToRefs, bC as usePinnedData, fs as useWorkflowActivate, ae as useNodeTypesStore, Q as useUIStore, a2 as useWorkflowsStore, cB as useDeviceSupport, cC as useTelemetryContext, aH as useTemplateRef, i_ as useNodeDocsUrl, dy as getNodeOutputs, g8 as NodeConnectionTypes, bN as START_NODE_TYPE, iH as EXECUTABLE_TRIGGER_NODE_TYPES, b2 as STICKY_NODE_TYPE, bo as useKeybindings, o as onMounted, iJ as dataPinningEventBus, X as onBeforeUnmount, ap as normalizeStyle, ca as useStyles, i$ as getNodeIconSource, iL as InputPanel, iK as NodeSettings, aq as createEventBus, c9 as N8nResizeWrapper, iM as APP_MODALS_ELEMENT_ID, bi as Teleport, al as useTelemetry, am as useMessage, an as MODAL_CONFIRM, bs as useExternalHooks } from "./index-C2iJCVYf.js";
import { N as NDVFloatingNodes, T as TriggerPanel, O as OutputPanel } from "./TriggerPanel-nPxZrihp.js";
import "./useLogsTreeExpand-2auAOTOK.js";
import "./AnimatedSpinner-DFjfUB--.js";
import "./RunDataParsedAiContent-BkNc-yBy.js";
import "./core-DsTi4w-I.js";
import "./NodeView-C9PvNIUz.js";
import "./global-link-actions-DSKsOCqo.js";
import "./useExecutionDebugging-DWOhAQo4.js";
import "./useBeforeUnload-D788NzAs.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.icon ? (openBlock(), createBlock(NodeIcon, {
            key: 0,
        ...
        createBaseVNode("div", {
          ...
          _ctx.docsUrl ? (openBlock(), createBlock(unref(N8nLink), {
            key: 0,
            theme: "text",
            target: "_blank",
            href: _ctx.docsUrl
            ...
            default: withCtx(() => [
              createBaseVNode("span", {
                ...
                createVNode(unref(N8nText), {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(i18n).baseText("nodeSettings.docs")), 1)
                  ]),
                  _: 1
                }),
...
const ndvHeader = "_ndvHeader_1e58b_2";
const content = "_content_1e58b_12";
const actions = "_actions_1e58b_19";
const title = "_title_1e58b_34";
const docsLabel = "_docsLabel_1e58b_39";
const icon = "_icon_1e58b_44";
const style0$2 = {
  ndvHeader,
  content,
  actions,
...
const NDVHeader = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2]]);
      ...
      return openBlock(), createBlock(Draggable, {
        ...
        default: withCtx(({ isDragging }) => [
          createBaseVNode("button", {
            ...
            _ctx.canMoveLeft ? (openBlock(), createBlock(unref(N8nIcon), {
              key: 0,
            ...
            _ctx.canMoveRight ? (openBlock(), createBlock(unref(N8nIcon), {
              key: 1,
              class: normalizeClass(_ctx.$style.arrow),
              icon: "arrow-right"
            }, null, 8, ["class"])) : createCommentVNode("", true)
...
const dragButton = "_dragButton_aofeu_123";
const arrow = "_arrow_aofeu_138";
const handle = "_handle_aofeu_142";
const dragging = "_dragging_aofeu_146";
const style0$1 = {
  dragButton,
  arrow,
  handle,
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("main", {
              ...
              hasInputPanel.value ? (openBlock(), createElementBlock("div", {
                ...
                }, null, 8, ["workflow-object", "can-link-runs", "run-index", "linked-runs", "active-node-name", "current-node-name", "push-ref", "read-only", "is-production-execution-preview", "search-shortcut", "display-mode", "class", "is-mapping-onboarded", "focused-mappable-input"])) : createCommentVNode("", true)
...
const backdrop = "_backdrop_1gh2u_123";
const dialog = "_dialog_1gh2u_133";
const container = "_container_1gh2u_148";
const main = "_main_1gh2u_159";
const column = "_column_1gh2u_169";
const input = "_input_1gh2u_182";
const output = "_output_1gh2u_183";
const dataColumn = "_dataColumn_1gh2u_187";
const header = "_header_1gh2u_191";
const settings = "_settings_1gh2u_197";
const draggable = "_draggable_1gh2u_202";
const style0 = {
  backdrop,
  dialog,
  container,
