import { d as defineComponent, Q as useUIStore, d1 as useCredentialsStore, av as useProjectsStore, x as computed, c as useI18n, aC as getResourcePermissions, gN as dateFormat, e as createBlock, g as openBlock, k as unref, s as N8nCard, B as withModifiers, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, h as createElementBlock, f as createCommentVNode, b4 as withDirectives, t as toDisplayString, b5 as vShow, l as createTextVNode, eO as _sfc_main$2, p as N8nText, aU as ResourceType, gU as ProjectCardBadge, ee as N8nActionToggle, aL as N8nBadge, he as CredentialIcon, am as useMessage, an as MODAL_CONFIRM, aV as PROJECT_MOVE_RESOURCE_MODAL, _ as _export_sfc, ae as useNodeTypesStore, af as useSourceControlStore, d2 as useExternalSecretsStore, u as useUsersStore, g$ as useInsightsStore, ay as useDocumentTitle, a3 as useRoute, b as useRouter, r as ref, hf as listenForModalChanges, a8 as watch, o as onMounted, dW as N8nActionBox, e3 as N8nInputLabel, e6 as N8nSelect, F as Fragment, A as renderList, e7 as _sfc_main$4, f2 as N8nCheckbox, hg as CREDENTIAL_EMPTY_VALUE, al as useTelemetry, v as useSettingsStore, aF as EnterpriseEditionFeature, cA as useEnvironmentsStore, hh as CREDENTIAL_SELECT_MODAL_KEY, V as VIEWS, hi as CREDENTIAL_EDIT_MODAL_KEY, hj as isCredentialsResource } from "./index-C2iJCVYf.js";
import { _ as _sfc_main$3 } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-BiphSIS4.js";
...
import { p as pickBy } from "./pickBy-DSRQa7Nf.js";
        ...
        header: withCtx(() => [
          createVNode(unref(N8nText), {
            ...
            default: withCtx(() => [
              ...
              _ctx.needsSetup ? (openBlock(), createBlock(unref(N8nBadge), {
                key: 1,
                class: "ml-3xs",
                theme: "warning"
              }, {
...
const cardLink = "_cardLink_1g76h_123";
const cardHeading = "_cardHeading_1g76h_133";
const cardDescription = "_cardDescription_1g76h_138";
const cardActions = "_cardActions_1g76h_145";
const cardBadge = "_cardBadge_1g76h_165";
const style0$1 = {
  cardLink,
  cardHeading,
  cardDescription,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(ResourcesListLayout, {
        ...
        empty: withCtx(() => [
          unref(overview).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(_sfc_main$3, {
            key: 0,
            "personal-project": personalProject.value,
            "resource-type": "credentials"
          }, null, 8, ["personal-project"])) : (openBlock(), createBlock(unref(N8nActionBox), {
            key: 1,
