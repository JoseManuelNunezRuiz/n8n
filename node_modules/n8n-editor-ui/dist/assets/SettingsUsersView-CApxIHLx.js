import { d as defineComponent, r as ref, e1 as ROLE, x as computed, h as createElementBlock, g as openBlock, e as createBlock, w as withCtx, i as createVNode, k as unref, ed as ElRadio, j as createBaseVNode, p as N8nText, l as createTextVNode, t as toDisplayString, n as normalizeClass, N as N8nIcon, aO as N8nActionDropdown, _ as _export_sfc, c as useI18n, f as createCommentVNode, F as Fragment, A as renderList, aa as N8nTooltip, ee as N8nActionToggle, ef as formatTimeAgo, eg as mergeModels, eh as useModel, aE as hasPermission, ei as N8nDataTableServer, J as N8nUserInfo, bS as normalizeProps, bT as guardReactiveProps, bZ as useClipboard, a as useToast, v as useSettingsStore, Q as useUIStore, u as useUsersStore, dV as useSSOStore, ay as useDocumentTitle, aB as usePageRedirectionHelper, aF as EnterpriseEditionFeature, o as onMounted, ej as USERS_LIST_SORT_OPTIONS, m as N8nHeading, dW as N8nActionBox, ac as I18nT, C as N8nLink, e5 as N8nNotice, aL as N8nBadge, ek as ElSwitch, aM as _sfc_main$6, cT as N8nInput, q as N8nButton, el as INVITE_USER_MODAL_KEY, em as DELETE_USER_MODAL_KEY, en as useDebounceFn } from "./index-C2iJCVYf.js";
...
const roleLabel = "_roleLabel_uhits_123";
const radioLabel = "_radioLabel_uhits_133";
const removeUser = "_removeUser_uhits_143";
const style0$2 = {
  roleLabel,
  radioLabel,
  removeUser
...
const projects = "_projects_1l6q5_123";
const project = "_project_1l6q5_123";
const comma = "_comma_1l6q5_138";
const projectList = "_projectList_1l6q5_143";
const style0$1 = {
  projects,
  project,
  comma,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        props.data.signInType !== "ldap" && props.actions.length > 0 ? (openBlock(), createBlock(unref(N8nActionToggle), {
          key: 0,
          placement: "bottom",
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(unref(N8nHeading), {
          ...
          default: withCtx(() => [
            ...
            !showUMSetupWarning.value ? (openBlock(), createBlock(unref(N8nText), {
              key: 0,
        ...
        !isAdvancedPermissionsEnabled.value ? (openBlock(), createBlock(unref(N8nNotice), { key: 1 }, {
          default: withCtx(() => [
          ...
          createBaseVNode("div", {
            ...
            createVNode(unref(N8nText), { bold: true }, {
              default: withCtx(() => [
                ...
                !isEnforceMFAEnabled.value ? (openBlock(), createBlock(unref(N8nBadge), {
                  key: 0,
                  class: "ml-4xs"
                }, {
                  default: withCtx(() => [
...
const userCount = "_userCount_1n3d0_123";
const buttonContainer = "_buttonContainer_1n3d0_128";
const search = "_search_1n3d0_135";
const setupInfoContainer = "_setupInfoContainer_1n3d0_139";
const settingsContainer = "_settingsContainer_1n3d0_143";
const settingsContainerInfo = "_settingsContainerInfo_1n3d0_154";
const settingsContainerAction = "_settingsContainerAction_1n3d0_163";
const container = "_container_1n3d0_171";
const style0 = {
  userCount,
  buttonContainer,
  search,
