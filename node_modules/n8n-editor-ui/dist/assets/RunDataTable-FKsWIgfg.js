import { d as defineComponent, at as useCssModule, x as computed, eD as getCurrentInstance, h as createElementBlock, f as createCommentVNode, g as openBlock, F as Fragment, A as renderList, n as normalizeClass, k as unref, Y as renderSlot, j as createBaseVNode, t as toDisplayString, e as createBlock, b_ as createSlots, w as withCtx, K as mergeProps, _ as _export_sfc, aH as useTemplateRef, r as ref, a_ as useNDVStore, a2 as useWorkflowsStore, cC as useTelemetryContext, dD as useExecutionHelpers, ev as storeToRefs, o as onMounted, a8 as watch, b4 as withDirectives, i as createVNode, ab as _sfc_main$2, b5 as vShow, c as useI18n, aa as N8nTooltip, l as createTextVNode, cK as InfoTip, h2 as Draggable, im as TextWithHighlights, N as N8nIcon, io as MappingPill, ip as shorten, ac as I18nT, iq as getPairedItemId, ir as getMappedExpression, bs as useExternalHooks, al as useTelemetry } from "./index-C2iJCVYf.js";
const _hoisted_1$1 = {
  key: 0,
  class: "n8n-tree"
};
...
const indent = "_indent_ggz6e_123";
const simple = "_simple_ggz6e_127";
const style0$1 = {
  indent,
  simple
};
...
const dataDisplay = "_dataDisplay_fhmfi_123";
const compact = "_compact_fhmfi_135";
const table = "_table_fhmfi_139";
const lightHeader = "_lightHeader_fhmfi_156";
const tableRightMargin = "_tableRightMargin_fhmfi_159";
const hasCollapsingColumn = "_hasCollapsingColumn_fhmfi_194";
const isCollapsingColumn = "_isCollapsingColumn_fhmfi_197";
const nodeClass = "_nodeClass_fhmfi_226";
const emptyCell = "_emptyCell_fhmfi_230";
const header = "_header_fhmfi_234";
const draggableHeader = "_draggableHeader_fhmfi_246";
const dragButton = "_dragButton_fhmfi_250";
const highlight = "_highlight_fhmfi_254";
const draggingHeader = "_draggingHeader_fhmfi_258";
const activeHeader = "_activeHeader_fhmfi_263";
const dataKey = "_dataKey_fhmfi_274";
const value = "_value_fhmfi_283";
const nestedValue = "_nestedValue_fhmfi_287 _value_fhmfi_283";
const mappable = "_mappable_fhmfi_292";
const empty = "_empty_fhmfi_230";
const limitColWidth = "_limitColWidth_fhmfi_301";
const minColWidth = "_minColWidth_fhmfi_305";
const hoveringKey = "_hoveringKey_fhmfi_309";
const draggingKey = "_draggingKey_fhmfi_313";
const hoveringRow = "_hoveringRow_fhmfi_329";
const warningTooltip = "_warningTooltip_fhmfi_334";
const executionLinkCell = "_executionLinkCell_fhmfi_338";
const executionLinkRowHeader = "_executionLinkRowHeader_fhmfi_342";
const collapseColumnButton = "_collapseColumnButton_fhmfi_346";
const isHoveredColumn = "_isHoveredColumn_fhmfi_353";
const style0 = {
  dataDisplay,
  compact,
  table,
