import { d as defineComponent, a3 as useRoute, dD as useExecutionHelpers, a2 as useWorkflowsStore, v as useSettingsStore, x as computed, aF as EnterpriseEditionFeature, c as useI18n, o as onMounted, a9 as resolveComponent, h as createElementBlock, g as openBlock, n as normalizeClass, i as createVNode, k as unref, V as VIEWS, w as withCtx, j as createBaseVNode, e as createBlock, f as createCommentVNode, p as N8nText, l as createTextVNode, t as toDisplayString, dE as toDayMonth, dF as _sfc_main$4, dG as toTime, N as N8nIcon, aO as N8nActionDropdown, aa as N8nTooltip, _ as _export_sfc, b as useRouter, a$ as useExecutionsStore, aB as usePageRedirectionHelper, r as ref, aC as getResourcePermissions, a8 as watch, m as N8nHeading, dH as ElCheckbox, dI as N8nLoading, dJ as TransitionGroup, F as Fragment, A as renderList, dK as isComponentPublicInstance, az as useWorkflowSaving, di as onBeforeRouteLeave, db as getNodeViewTab, L as MAIN_HEADER_TABS, ae as useNodeTypesStore, av as useProjectsStore, a as useToast, P as useDebounce, bM as useCanvasOperations, a4 as PLACEHOLDER_EMPTY_WORKFLOW_ID, d9 as NEW_WORKFLOW_ID, X as onBeforeUnmount, dL as NO_NETWORK_ERROR_CODE, al as useTelemetry, dM as executionRetryMessage } from "./index-C2iJCVYf.js";
import { _ as _sfc_main$5, C as ConcurrentExecutionsHeader, E as ExecutionsFilter } from "./ExecutionsTime.vue_vue_type_script_setup_true_lang-8mG-89V4.js";
import { T as Tags } from "./Tags-DpegReyF.js";
import { W as WorkflowExecutionsInfoAccordion } from "./WorkflowExecutionsInfoAccordion-kaRsv7EW.js";
import "./AnnotationTagsDropdown.ee.vue_vue_type_script_setup_true_lang-AwTdMVsi.js";
import "./InfoAccordion-B_T19Esx.js";
        ...
        createVNode(_component_RouterLink, {
          ...
          default: withCtx(() => [
            createBaseVNode("div", {
              ...
              executionUIDetails.value.name === "new" ? (openBlock(), createBlock(unref(N8nText), {
                key: 0,
                color: "text-dark",
                bold: true,
                size: "medium",
              ...
              createBaseVNode("div", {
                ...
                executionUIDetails.value.name === "running" ? (openBlock(), createBlock(unref(_sfc_main$4), {
                  key: 0,
                  size: "small",
                ...
                executionUIDetails.value.name === "new" && _ctx.execution.createdAt ? (openBlock(), createBlock(unref(N8nText), {
                  key: 2,
                  color: isActive.value ? "text-dark" : "text-base",
                  size: "small"
                }, {
                  ...
                  _: 1
                }, 8, ["color"])) : executionUIDetails.value.runningTime !== "" ? (openBlock(), createBlock(unref(N8nText), {
                  key: 3,
                  color: isActive.value ? "text-dark" : "text-base",
                  size: "small"
                }, {
              ...
              isAnnotationEnabled.value ? (openBlock(), createElementBlock("div", {
                ...
                _ctx.execution.annotation?.vote ? (openBlock(), createElementBlock("div", {
                  ...
                  _ctx.execution.annotation.vote == "up" ? (openBlock(), createBlock(unref(N8nIcon), {
                    key: 0,
                    class: normalizeClass(_ctx.$style.up),
                    icon: "thumbs-up"
                  }, null, 8, ["class"])) : (openBlock(), createBlock(unref(N8nIcon), {
                    key: 1,
                    class: normalizeClass(_ctx.$style.down),
                    icon: "thumbs-down"
                  }, null, 8, ["class"]))
                ], 2)) : createCommentVNode("", true),
                executionUIDetails.value.tags.length > 0 ? (openBlock(), createBlock(unref(Tags), {
                  key: 1,
            ...
            createBaseVNode("div", {
              ...
              isRetriable.value ? (openBlock(), createBlock(unref(N8nActionDropdown), {
                key: 0,
              ...
              _ctx.execution.mode === "manual" ? (openBlock(), createBlock(unref(N8nTooltip), {
                key: 1,
                placement: "top"
              }, {
                content: withCtx(() => [
              ...
              _ctx.execution.mode === "evaluation" ? (openBlock(), createBlock(unref(N8nTooltip), {
                key: 2,
                placement: "top"
              }, {
                content: withCtx(() => [
...
const WorkflowExecutionsCard$1 = "_WorkflowExecutionsCard_1ujrd_123";
const active = "_active_1ujrd_130";
const executionStatus = "_executionStatus_1ujrd_133";
const executionLink = "_executionLink_1ujrd_136";
const spinner = "_spinner_1ujrd_139";
const running = "_running_1ujrd_139";
const statusLabel = "_statusLabel_1ujrd_146";
const success = "_success_1ujrd_151";
const waiting = "_waiting_1ujrd_160";
const error = "_error_1ujrd_166";
const unknown = "_unknown_1ujrd_172";
const annotation = "_annotation_1ujrd_175";
const ratingIcon = "_ratingIcon_1ujrd_182";
const up = "_up_1ujrd_182";
const down = "_down_1ujrd_185";
const icon = "_icon_1ujrd_202";
const icons = "_icons_1ujrd_207";
const retry = "_retry_1ujrd_215";
const manual = "_manual_1ujrd_218";
const showGap = "_showGap_1ujrd_226";
const style0$2 = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          showConcurrencyHeader.value ? (openBlock(), createBlock(ConcurrentExecutionsHeader, {
            key: 0,
        ...
        createBaseVNode("div", {
          ...
          _ctx.loading ? (openBlock(), createElementBlock("div", _hoisted_1, [
            createVNode(unref(N8nLoading), { variant: "rect" })
          ])) : createCommentVNode("", true),
...
const container$1 = "_container_hrgxj_123";
const heading = "_heading_hrgxj_135";
const controls = "_controls_hrgxj_142";
const executionList = "_executionList_hrgxj_154";
const infoAccordion = "_infoAccordion_hrgxj_172";
const noResultsContainer = "_noResultsContainer_hrgxj_185";
const style0$1 = {
...
const WorkflowExecutionsSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1], ["__scopeId", "data-v-4adacd9b"]]);
