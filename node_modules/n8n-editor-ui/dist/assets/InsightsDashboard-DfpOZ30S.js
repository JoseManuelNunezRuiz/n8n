const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CKH7O7yd.js","assets/index-C2iJCVYf.js","assets/index-BvbpnRSm.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DW-EkNtK.js","assets/chartjs.utils-nj8CCZPZ.js","assets/InsightsSummary-ChZNMeJI.js","assets/InsightsSummary-BazqPYQ0.css","assets/index-DkYsG7tJ.js","assets/InsightsChartFailed-DRHEEzJU.js","assets/InsightsChartFailureRate-D1L6WYZP.js","assets/InsightsChartTimeSaved-zCEK3kuY.js","assets/InsightsChartAverageRuntime-IISuKphn.js","assets/InsightsTableWorkflows-DwLRkvVL.js","assets/InsightsTableWorkflows-D20Yb7ZW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eh as useModel, g$ as useInsightsStore, h9 as getTimeRangeLabels, r as ref, hU as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, k as unref, e7 as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e6 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, f6 as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hV as INSIGHT_TYPES, dm as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b3 as onBeforeMount, m as N8nHeading, n as normalizeClass, gq as ProjectSharing, dF as _sfc_main$4, bu as resolveDynamicComponent, aW as __vitePreload, al as useTelemetry, hW as TELEMETRY_TIME_RANGE } from "./index-C2iJCVYf.js";
...
const InsightsUpgradeModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6866dc42"]]);
const _hoisted_1 = {
  class: "mt-s",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CKH7O7yd.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DW-EkNtK.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-DRHEEzJU.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-D1L6WYZP.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-zCEK3kuY.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-IISuKphn.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DwLRkvVL.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
...
const insightsView = "_insightsView_1ob2s_123";
const insightsContainer = "_insightsContainer_1ob2s_131";
const insightsBanner = "_insightsBanner_1ob2s_138";
const insightsContent = "_insightsContent_1ob2s_146";
const insightsContentWrapper = "_insightsContentWrapper_1ob2s_155";
const insightsChartWrapper = "_insightsChartWrapper_1ob2s_160";
const insightsTableWrapper = "_insightsTableWrapper_1ob2s_167";
const dataLoader = "_dataLoader_1ob2s_173";
const isDataLoading = "_isDataLoading_1ob2s_186";
const projectSelect = "_projectSelect_1ob2s_208";
const style0 = {
  insightsView,
  insightsContainer,
  insightsBanner,
