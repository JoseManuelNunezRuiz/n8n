import { d as defineComponent, a2 as useWorkflowsStore, a3 as useRoute, r as ref, x as computed, aC as getResourcePermissions, c0 as resolveDirective, e as createBlock, f as createCommentVNode, g as openBlock, k as unref, E as ElDropdown, w as withCtx, i as createVNode, q as N8nButton, n as normalizeClass, c as useI18n, aL as N8nBadge, l as createTextVNode, t as toDisplayString, j as createBaseVNode, h as createElementBlock, m as N8nHeading, F as Fragment, A as renderList, p as N8nText, b4 as withDirectives, _ as _export_sfc, a as useToast, a$ as useExecutionsStore, aq as createEventBus, ar as ElTag, al as useTelemetry, ab as _sfc_main$5, dD as useExecutionHelpers, v as useSettingsStore, aF as EnterpriseEditionFeature, a9 as resolveComponent, dF as _sfc_main$6, V as VIEWS, H as ElDropdownMenu, I as ElDropdownItem, am as useMessage, an as MODAL_CONFIRM } from "./index-C2iJCVYf.js";
import { _ as _sfc_main$4 } from "./AnnotationTagsDropdown.ee.vue_vue_type_script_setup_true_lang-AwTdMVsi.js";
import { W as WorkflowPreview } from "./WorkflowPreview-B8KvmFRP.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-DWOhAQo4.js";
      ...
      return _ctx.execution ? (openBlock(), createBlock(unref(ElDropdown), {
        ...
        default: withCtx(() => [
          createVNode(unref(N8nButton), {
            ...
            default: withCtx(() => [
              customDataLength.value > 0 ? (openBlock(), createBlock(unref(N8nBadge), {
                key: 0,
...
const highlightDataButton$1 = "_highlightDataButton_1im5x_123";
const highlightDataButtonActive$1 = "_highlightDataButtonActive_1im5x_128";
const highlightDataButtonOpen$1 = "_highlightDataButtonOpen_1im5x_132";
const badge$1 = "_badge_1im5x_138";
const container = "_container_1im5x_142";
const section = "_section_1im5x_154";
const metadata = "_metadata_1im5x_163";
const heading = "_heading_1im5x_167";
const controls = "_controls_1im5x_174";
const customDataEntry = "_customDataEntry_1im5x_186";
const key = "_key_1im5x_193";
const noResultsContainer = "_noResultsContainer_1im5x_197";
const style0$3 = {
  ...
  key,
  noResultsContainer,
  "execution-annotation-panel": "_execution-annotation-panel_1im5x_202",
  "el-skeleton__item": "_el-skeleton__item_1im5x_202"
};
const cssModules$3 = {
  "$style": style0$3
};
const WorkflowExecutionAnnotationPanel = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__cssModules", cssModules$3]]);
...
const tags = "_tags_swdo6_123";
const addTagButton = "_addTagButton_swdo6_128";
const addTagButtonIconOnly = "_addTagButtonIconOnly_swdo6_149";
const tagsContainer = "_tagsContainer_swdo6_154";
const style0$2 = {
  tags,
  addTagButton,
...
const WorkflowExecutionAnnotationTags = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2]]);
...
const ratingIcon = "_ratingIcon_w647n_123";
const icon = "_icon_w647n_127";
const up = "_up_w647n_130";
const down = "_down_w647n_130";
const style0$1 = {
  ratingIcon,
  icon,
  up,
...
const VoteButtons = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__cssModules", cssModules$1]]);
    ...
    return (_ctx, _cache) => {
      ...
      return executionUIDetails.value?.name === "new" ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createVNode(unref(_sfc_main$6), { type: "ring" })
        ], 2),
        createVNode(unref(N8nText), {
        ...
        _ctx.execution ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              isAnnotationEnabled.value && _ctx.execution ? (openBlock(), createBlock(VoteButtons, {
                key: 0,
            ...
            createBaseVNode("div", {
              ...
              executionUIDetails.value?.name === "running" ? (openBlock(), createBlock(unref(_sfc_main$6), {
                key: 0,
                size: "small",
...
const previewContainer = "_previewContainer_t75a4_123";
const executionDetails = "_executionDetails_t75a4_129";
const executionDetailsLeft = "_executionDetailsLeft_t75a4_147";
const executionTitle = "_executionTitle_t75a4_153";
const voteButtons = "_voteButtons_t75a4_159";
const spinner = "_spinner_t75a4_163";
const running = "_running_t75a4_169";
const waiting = "_waiting_t75a4_174";
const success = "_success_t75a4_178";
const error = "_error_t75a4_182";
const newInfo = "_newInfo_t75a4_186";
const runningInfo = "_runningInfo_t75a4_187";
const newMessage = "_newMessage_t75a4_194";
const runningMessage = "_runningMessage_t75a4_195";
const debugLink = "_debugLink_t75a4_201";
const actions = "_actions_t75a4_206";
const highlightDataButton = "_highlightDataButton_t75a4_211";
const highlightDataButtonActive = "_highlightDataButtonActive_t75a4_216";
const highlightDataButtonOpen = "_highlightDataButtonOpen_t75a4_220";
const badge = "_badge_t75a4_226";
const style0 = {
  previewContainer,
  executionDetails,
