const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-C5Cvqjc_.js","assets/index-C2iJCVYf.js","assets/index-BvbpnRSm.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-CZx7rSSE.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, a_ as useNDVStore, cC as useTelemetryContext, r as ref, h6 as useElementSize, x as computed, is as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, k as unref, dm as defineAsyncComponent, dl as Suspense, it as VueJsonPretty, im as TextWithHighlights, n as normalizeClass, io as MappingPill, h2 as Draggable, aW as __vitePreload, ip as shorten, ir as getMappedExpression, iu as isString, iv as nonExistingJsonPath, bs as useExternalHooks, al as useTelemetry, _ as _export_sfc } from "./index-C2iJCVYf.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-C5Cvqjc_.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
...
const jsonDisplay = "_jsonDisplay_m86z6_123";
const mappable = "_mappable_m86z6_140";
const highlight = "_highlight_m86z6_146";
const dragged = "_dragged_m86z6_147";
const compact = "_compact_m86z6_152";
const style0 = {
  jsonDisplay,
  mappable,
  highlight,
