import { d as defineComponent, a as useToast, a$ as useExecutionsStore, av as useProjectsStore, r as ref, x as computed, o as onMounted, X as onBeforeUnmount, a8 as watch, h as createElementBlock, g as openBlock, f as createCommentVNode, j as createBaseVNode, n as normalizeClass, i as createVNode, k as unref, dI as N8nLoading, dF as _sfc_main$1, c as useI18n, _ as _export_sfc } from "./index-C2iJCVYf.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.loaderType === "image" && !showPreview.value ? (openBlock(), createElementBlock("div", {
          ...
          createVNode(unref(_sfc_main$1), { type: "dots" })
...
const container = "_container_tgopm_123";
const workflow = "_workflow_tgopm_130";
const show = "_show_tgopm_136";
const openNDV = "_openNDV_tgopm_142";
const spinner = "_spinner_tgopm_151";
const imageLoader = "_imageLoader_tgopm_159";
const executionPreview = "_executionPreview_tgopm_167";
const style0 = {
  container,
  workflow,
  show,
