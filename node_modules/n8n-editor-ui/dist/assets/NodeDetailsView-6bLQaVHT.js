import { d as defineComponent, e as createBlock, g as openBlock, h2 as Draggable, n as normalizeClass, w as withCtx, j as createBaseVNode, h as createElementBlock, f as createCommentVNode, i as createVNode, k as unref, N as N8nIcon, _ as _export_sfc, cJ as useThrottleFn, a_ as useNDVStore, Q as useUIStore, r as ref, gt as useSlots, o as onMounted, x as computed, cm as ndvEventBus, X as onBeforeUnmount, a8 as watch, iF as MAIN_NODE_PANEL_WIDTH, bc as useStorage, iG as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, ap as normalizeStyle, Y as renderSlot, c9 as N8nResizeWrapper, Z as nextTick, bG as useNodeHelpers, ev as storeToRefs, bC as usePinnedData, fs as useWorkflowActivate, ae as useNodeTypesStore, a2 as useWorkflowsStore, cB as useDeviceSupport, cC as useTelemetryContext, dy as getNodeOutputs, g8 as NodeConnectionTypes, bN as START_NODE_TYPE, iH as EXECUTABLE_TRIGGER_NODE_TYPES, b2 as STICKY_NODE_TYPE, iI as BASE_NODE_SURVEY_URL, iJ as dataPinningEventBus, aa as N8nTooltip, p as N8nText, l as createTextVNode, t as toDisplayString, c as useI18n, b_ as createSlots, iK as NodeSettings, aq as createEventBus, iL as InputPanel, ca as useStyles, iM as APP_MODALS_ELEMENT_ID, f6 as ElDialog, al as useTelemetry, am as useMessage, an as MODAL_CONFIRM, dd as jsonParse, bs as useExternalHooks } from "./index-C2iJCVYf.js";
import { N as NDVFloatingNodes, O as OutputPanel, T as TriggerPanel } from "./TriggerPanel-nPxZrihp.js";
        ...
        default: withCtx(({ isDragging }) => [
          createBaseVNode("div", {
            ...
            _ctx.canMoveRight ? (openBlock(), createElementBlock("span", {
              ...
              createVNode(unref(N8nIcon), { icon: "arrow-right" })
            ], 2)) : createCommentVNode("", true),
            createBaseVNode("div", {
...
const dragContainer = "_dragContainer_1jj9p_123";
const dragButton = "_dragButton_1jj9p_127";
const leftArrow = "_leftArrow_1jj9p_141 _arrow_1jj9p_150";
const rightArrow = "_rightArrow_1jj9p_142 _arrow_1jj9p_150";
const visible$1 = "_visible_1jj9p_146";
const arrow = "_arrow_1jj9p_150";
const grid = "_grid_1jj9p_168";
const style0$1 = {
  dragContainer,
  dragButton,
  leftArrow,
            ...
            (openBlock(), createBlock(NDVDraggablePanels, {
              ...
              main: withCtx(() => [
                ...
                featureRequestUrl.value ? (openBlock(), createElementBlock("a", {
                  ...
                  createVNode(unref(N8nIcon), { icon: "lightbulb" }),
...
const modalBackground = "_modalBackground_rmwfp_123";
const triggerWarning = "_triggerWarning_rmwfp_128";
const backToCanvas = "_backToCanvas_rmwfp_132";
const featureRequest = "_featureRequest_rmwfp_153";
const style1 = {
  modalBackground,
  triggerWarning,
  backToCanvas,
