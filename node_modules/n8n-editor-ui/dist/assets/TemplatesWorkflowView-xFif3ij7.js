import { d as defineComponent, bk as useTemplatesStore, ae as useNodeTypesStore, a3 as useRoute, b as useRouter, ay as useDocumentTitle, r as ref, x as computed, a8 as watch, o as onMounted, e as createBlock, g as openBlock, b_ as createSlots, w as withCtx, j as createBaseVNode, n as normalizeClass, f as createCommentVNode, i as createVNode, k as unref, eL as N8nMarkdown, c as useI18n, h as createElementBlock, m as N8nHeading, l as createTextVNode, t as toDisplayString, p as N8nText, dI as N8nLoading, q as N8nButton, al as useTelemetry, bs as useExternalHooks, _ as _export_sfc } from "./index-C2iJCVYf.js";
import { u as useTemplateWorkflow } from "./templateActions-CqLHZUrv.js";
import { T as TemplateDetails } from "./TemplateDetails-lJNnuxdO.js";
import { W as WorkflowPreview } from "./WorkflowPreview-B8KvmFRP.js";
import { T as TemplatesView } from "./TemplatesView-BTxutjLU.js";
import "./Tags-DpegReyF.js";
        ...
        header: withCtx(() => [
          !notFoundError.value ? (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              ...
              template.value && template.value.name ? (openBlock(), createBlock(unref(N8nHeading), {
                key: 0,
                tag: "h1",
                size: "2xlarge"
              }, {
              ...
              template.value && template.value.name ? (openBlock(), createBlock(unref(N8nText), {
                key: 1,
                color: "text-base",
                size: "small"
              }, {
            ...
            createBaseVNode("div", {
              ...
              template.value ? (openBlock(), createBlock(unref(N8nButton), {
                key: 0,
        ...
        !notFoundError.value ? {
          ...
          fn: withCtx(() => [
            createBaseVNode("div", {
              ...
              showPreview.value ? (openBlock(), createBlock(WorkflowPreview, {
                key: 0,
...
const wrapper = "_wrapper_tqev9_123";
const notFound = "_notFound_tqev9_128";
const title = "_title_tqev9_132";
const button = "_button_tqev9_136";
const image = "_image_tqev9_140";
const content = "_content_tqev9_151";
const markdown = "_markdown_tqev9_162";
const details = "_details_tqev9_173";
const style0 = {
  wrapper,
  notFound,
  title,
