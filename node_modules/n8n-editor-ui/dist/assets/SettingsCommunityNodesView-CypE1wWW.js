import { d as defineComponent, Q as useUIStore, v as useSettingsStore, ae as useNodeTypesStore, r as ref, x as computed, eo as semver, ep as COMMUNITY_PACKAGE_MANAGE_ACTIONS, c as useI18n, a8 as watch, h as createElementBlock, g as openBlock, n as normalizeClass, f as createCommentVNode, i as createVNode, k as unref, dI as N8nLoading, j as createBaseVNode, p as N8nText, w as withCtx, l as createTextVNode, t as toDisplayString, F as Fragment, A as renderList, e as createBlock, N as N8nIcon, aa as N8nTooltip, q as N8nButton, ee as N8nActionToggle, al as useTelemetry, eq as NPM_PACKAGE_DOCS_BASE_URL, _ as _export_sfc, b as useRouter, a1 as usePushConnectionStore, a as useToast, ay as useDocumentTitle, er as useCommunityNodesStore, es as COMMUNITY_NODES_INSTALLATION_DOCS_URL, b3 as onBeforeMount, o as onMounted, X as onBeforeUnmount, m as N8nHeading, dW as N8nActionBox, bs as useExternalHooks, et as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY } from "./index-C2iJCVYf.js";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.loading ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", {
            ...
            _ctx.communityPackage.failedLoading === true ? (openBlock(), createBlock(unref(N8nTooltip), {
              key: 0,
              placement: "top"
            }, {
              content: withCtx(() => [
              ...
              _: 1
            })) : hasUnverifiedPackagesUpdate.value || hasVerifiedPackageUpdate.value ? (openBlock(), createBlock(unref(N8nTooltip), {
              key: 1,
              placement: "top"
            }, {
              content: withCtx(() => [
...
const cardContainer = "_cardContainer_1ftiy_123";
const packageCard = "_packageCard_1ftiy_131";
const cardSkeleton = "_cardSkeleton_1ftiy_132";
const loader = "_loader_1ftiy_146";
const cardInfoContainer = "_cardInfoContainer_1ftiy_157";
const cardTitle = "_cardTitle_1ftiy_162";
const cardSubtitle = "_cardSubtitle_1ftiy_169";
const cardControlsContainer = "_cardControlsContainer_1ftiy_174";
const cardActions = "_cardActions_1ftiy_180";
const style0$1 = {
  cardContainer,
  packageCard,
  cardSkeleton,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          unref(settingsStore).isUnverifiedPackagesEnabled && unref(communityNodesStore).getInstalledPackages.length > 0 && !loading.value ? (openBlock(), createBlock(unref(N8nButton), {
            key: 0,
...
const container = "_container_it0uc_123";
const headingContainer = "_headingContainer_it0uc_131";
const loadingContainer = "_loadingContainer_it0uc_136";
const actionBoxContainer = "_actionBoxContainer_it0uc_141";
const cardsContainer = "_cardsContainer_it0uc_145";
const style0 = {
  container,
  headingContainer,
  loadingContainer,
