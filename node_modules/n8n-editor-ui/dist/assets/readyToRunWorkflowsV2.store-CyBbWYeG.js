import { aw as useFoldersStore, a3 as useRoute, a0 as defineStore, a as useToast, b as useRouter, d1 as useCredentialsStore, u as useUsersStore, v as useSettingsStore, bn as usePostHog, b9 as useCloudPlanStore, a2 as useWorkflowsStore, x as computed, fz as READY_TO_RUN_V2_PART2_EXPERIMENT, b0 as useLocalStorage, r as ref, fv as OPEN_AI_API_CREDENTIAL_TYPE, a8 as watch, al as useTelemetry, c as useI18n, dN as deepCopy, V as VIEWS, a5 as STORES } from "./index-C2iJCVYf.js";
...
const useReadyToRunWorkflowsV2Store = defineStore(
  ...
  () => {
    ...
    const isFeatureEnabled = computed(() => {
      ...
      return (variant === READY_TO_RUN_V2_PART2_EXPERIMENT.variant3 || variant === READY_TO_RUN_V2_PART2_EXPERIMENT.variant4) && cloudPlanStore.userIsTrialing && !hasChosenHubSpot.value;
    });
