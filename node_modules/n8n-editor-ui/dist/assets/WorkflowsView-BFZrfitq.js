import { d as defineComponent, a3 as useRoute, b as useRouter, aw as useFoldersStore, r as ref, x as computed, c as useI18n, aG as ProjectTypes, V as VIEWS, a9 as resolveComponent, h as createElementBlock, g as openBlock, i as createVNode, w as withCtx, k as unref, s as N8nCard, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, e as createBlock, gU as ProjectCardBadge, aU as ResourceType, ee as N8nActionToggle, B as withModifiers, p as N8nText, l as createTextVNode, t as toDisplayString, eO as _sfc_main$a, m as N8nHeading, aL as N8nBadge, N as N8nIcon, gV as FOLDER_LIST_ITEM_ACTIONS, _ as _export_sfc, a as useToast, Q as useUIStore, u as useUsersStore, a2 as useWorkflowsStore, av as useProjectsStore, aC as getResourcePermissions, gN as dateFormat, b4 as withDirectives, b5 as vShow, aa as N8nTooltip, aP as WORKFLOW_SHARE_MODAL_KEY, al as useTelemetry, aT as DUPLICATE_MODAL_KEY, am as useMessage, an as MODAL_CONFIRM, aV as PROJECT_MOVE_RESOURCE_MODAL, a8 as watch, ce as onScopeDispose, gW as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, gX as ILLEGAL_FOLDER_CHARACTERS, gY as FOLDER_NAME_ONLY_DOTS_REGEX, gZ as FOLDER_NAME_MAX_LENGTH, a0 as defineStore, bn as usePostHog, b9 as useCloudPlanStore, bk as useTemplatesStore, bc as useStorage, g_ as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, dd as jsonParse, fx as TEMPLATE_ONBOARDING_EXPERIMENT, a5 as STORES, z as N8nCallout, C as N8nLink, Y as renderSlot, ae as useNodeTypesStore, bl as usePersonalizedTemplatesV2Store, o as onMounted, c8 as NodeIcon, bB as EXPERIMENT_TEMPLATE_RECO_V2_KEY, F as Fragment, A as renderList, bg as usePersonalizedTemplatesV3Store, by as EXPERIMENT_TEMPLATE_RECO_V3_KEY, af as useSourceControlStore, bm as useCalloutHelpers, v as useSettingsStore, as as useTagsStore, f4 as useUsageStore, g$ as useInsightsStore, ay as useDocumentTitle, P as useDebounce, aH as useTemplateRef, aF as EnterpriseEditionFeature, h0 as isExtraTemplateLinksExperimentEnabled, aq as createEventBus, X as onBeforeUnmount, ao as debounce, h1 as PROJECT_ROOT, b_ as createSlots, q as N8nButton, cK as InfoTip, dW as N8nActionBox, e3 as N8nInputLabel, aK as _sfc_main$c, e6 as N8nSelect, e7 as _sfc_main$d, f2 as N8nCheckbox, h2 as Draggable, dI as N8nLoading, aI as InlineRename, h3 as DEFAULT_WORKFLOW_PAGE_SIZE, bz as trackTemplatesClick, bA as TemplateClickSource, h4 as getEasyAiWorkflowJson, f7 as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index-C2iJCVYf.js";
import { _ as _sfc_main$b } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-BiphSIS4.js";
import { W as WorkflowActivator, F as FolderBreadcrumbs } from "./WorkflowActivator-BdIK7K-g.js";
import { B as Breadcrumbs } from "./ProjectBreadcrumb-w-ZQjuc2.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-Db6ys3gY.js";
import { P as ProjectHeader } from "./ProjectHeader-DG_Z0cm0.js";
import { T as Tags } from "./Tags-DpegReyF.js";
import { u as useMCPStore } from "./mcp.store-LrK5gI5Y.js";
import { u as useProjectPages } from "./useProjectPages-BRhbuYJH.js";
import { u as useAITemplatesStarterCollectionStore, a as useReadyToRunWorkflowsStore } from "./readyToRunWorkflows.store-ia-2Nluj.js";
import { u as useReadyToRunWorkflowsV2Store } from "./readyToRunWorkflowsV2.store-CyBbWYeG.js";
import { I as InsightsSummary } from "./InsightsSummary-ChZNMeJI.js";
import "./PageViewLayout-DNBKIQ4N.js";
import "./TableBase-B1eTsHT8.js";
            ...
            createVNode(unref(N8nCard), {
              ...
              header: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  _ctx.readOnly ? (openBlock(), createBlock(unref(N8nBadge), {
                    key: 0,
                    class: "ml-3xs",
                    theme: "tertiary",
                    bold: ""
              ...
              footer: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  _ctx.data.workflowCount > 0 ? (openBlock(), createBlock(unref(N8nText), {
                    key: 0,
                    size: "small",
                    color: "text-light",
                  ...
                  _ctx.data.subFolderCount > 0 ? (openBlock(), createBlock(unref(N8nText), {
                    key: 1,
                    size: "small",
                    color: "text-light",
                    class: normalizeClass([_ctx.$style["info-cell"], _ctx.$style["info-cell--workflow-count"]]),
              ...
              append: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  _ctx.actions.length ? (openBlock(), createBlock(unref(N8nActionToggle), {
                    key: 1,
...
const FolderCard = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__cssModules", cssModules$9]]);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const actions = computed(() => {
      ...
      if (!props.readOnly && (workflowPermissions.value.update || workflowPermissions.value.move && projectsStore.isTeamProjectFeatureEnabled) && showFolders.value && route.name !== VIEWS.SHARED_WORKFLOWS) {
        items.push({
      ...
      return openBlock(), createBlock(unref(N8nCard), {
        ...
        header: withCtx(() => [
          createVNode(unref(N8nText), {
            ...
            default: withCtx(() => [
              createTextVNode(toDisplayString(_ctx.data.name) + " ", 1),
              !workflowPermissions.value.update ? (openBlock(), createBlock(unref(N8nBadge), {
                key: 0,
                class: "ml-3xs",
                theme: "tertiary",
                bold: ""
        ...
        append: withCtx(() => [
          createBaseVNode("div", {
            ...
            _ctx.data.isArchived ? (openBlock(), createBlock(unref(N8nText), {
              key: 1,
              color: "text-light",
              size: "small",
              bold: "",
...
const cardLink = "_cardLink_wwga6_123";
const cardHeading = "_cardHeading_wwga6_133";
const cardHeadingArchived = "_cardHeadingArchived_wwga6_142";
const cardDescription = "_cardDescription_wwga6_146";
const cardTags = "_cardTags_wwga6_156";
const cardActions = "_cardActions_wwga6_161";
const cardBadge = "_cardBadge_wwga6_172";
const cardArchived = "_cardArchived_wwga6_183";
const breadcrumbs = "_breadcrumbs_wwga6_209";
const style0$8 = {
  cardLink,
  cardHeading,
  cardHeadingArchived,
  ...
  cardActions,
  cardBadge,
  "with-breadcrumbs": "_with-breadcrumbs_wwga6_176",
  cardArchived,
  "description-cell--mcp": "_description-cell--mcp_wwga6_189",
  breadcrumbs
};
const cssModules$8 = {
  "$style": style0$8
...
const style0$7 = {
  "suggested-workflow-callout": "_suggested-workflow-callout_6544l_123",
  "callout-content": "_callout-content_6544l_129",
  "callout-trailing-content": "_callout-trailing-content_6544l_133"
};
const cssModules$7 = {
  "$style": style0$7
};
...
const nodeCard$1 = "_nodeCard_urxa7_123";
const nodeIcon$1 = "_nodeIcon_urxa7_133";
const emptyStateCardContent$2 = "_emptyStateCardContent_urxa7_137";
const style0$5 = {
  nodeCard: nodeCard$1,
  nodeIcon: nodeIcon$1,
...
const nodeCardsContainer$1 = "_nodeCardsContainer_ufnvi_123";
const style0$4 = {
...
const nodeCard = "_nodeCard_urxa7_123";
const nodeIcon = "_nodeIcon_urxa7_133";
const emptyStateCardContent$1 = "_emptyStateCardContent_urxa7_137";
const style0$3 = {
  nodeCard,
  nodeIcon,
...
const nodeCardsContainer = "_nodeCardsContainer_ufnvi_123";
const style0$2 = {
  nodeCardsContainer
};
const cssModules$2 = {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const showReadyToRunV2Card = computed(() => {
      return isLoadingReadyToRun.value || readyToRunWorkflowsV2Store.getCardVisibility(
        ...
        createBaseVNode("div", {
          ...
          !readOnlyEnv.value && projectPermissions.value.workflow.create ? (openBlock(), createElementBlock("div", {
            ...
            showReadyToRunV2Card.value ? (openBlock(), createBlock(unref(N8nCard), {
              ...
              _: 1
            }, 8, ["class", "hoverable"])) : createCommentVNode("", true),
            createVNode(unref(N8nCard), {
...
const simplifiedLayout = "_simplifiedLayout_pnu6z_123";
const header = "_header_pnu6z_131";
const content = "_content_pnu6z_138";
const welcome = "_welcome_pnu6z_146";
const welcomeTitle = "_welcomeTitle_pnu6z_150";
const welcomeDescription = "_welcomeDescription_pnu6z_154";
const actionsContainer$1 = "_actionsContainer_pnu6z_158";
const actionCard = "_actionCard_pnu6z_165";
const cardIcon = "_cardIcon_pnu6z_178";
const loading = "_loading_pnu6z_181";
const cardContent = "_cardContent_pnu6z_186";
const style0$1 = {
  simplifiedLayout,
  header,
  content,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const listScrollContainer = computed(() => {
      const component = resourcesListLayoutRef.value;
    ...
    const showReadyToRunWorkflowsCallout = computed(() => {
      ...
      return isEnabled && !isDismissed && !loading2.value && !readOnlyEnv.value && (projectPages.isOverviewSubPage || hasPermissionToCreateFolders.value && hasPermissionToCreateWorkflows.value);
    });
    const emptyListDescription = computed(() => {
      if (readOnlyEnv.value) {
        return i18n.baseText("workflows.empty.description.readOnlyEnv");
    ...
    const showAIStarterCollectionCallout = computed(() => {
      return !loading2.value && aiStarterTemplatesStore.isFeatureEnabled && !aiStarterTemplatesStore.calloutDismissed && !readOnlyEnv.value && // We want to show the callout only if the user has permissions to create folders and workflows
    ...
    const showPrebuiltAgentsCallout = computed(() => {
      return !loading2.value && calloutHelpers.isPreBuiltAgentsCalloutVisible.value && !calloutHelpers.isCalloutDismissed("preBuiltAgentsModalCallout") && !readOnlyEnv.value && // We want to show the callout only if the user has permissions to create folders and workflows
      // but also on the overview page
      (projectPages.isOverviewSubPage || hasPermissionToCreateFolders.value && hasPermissionToCreateWorkflows.value);
    });
    const showPersonalizedTemplates = computed(
      () => !loading2.value && personalizedTemplatesStore.isFeatureEnabled()
    );
    const shouldUseSimplifiedLayout = computed(() => {
      return readyToRunWorkflowsV2Store.getSimplifiedLayoutVisibility(route, loading2.value);
    });
    ...
    const showTemplateRecommendationV2 = computed(() => {
      return personalizedTemplatesV2Store.isFeatureEnabled() && !loading2.value;
    });
    const showTemplateRecommendationV3 = computed(() => {
      return personalizedTemplatesV3Store.isFeatureEnabled() && !loading2.value;
    });
    onMounted(async () => {
    ...
    return (_ctx, _cache) => {
      return shouldUseSimplifiedLayout.value ? (openBlock(), createBlock(SimplifiedEmptyLayout, {
        ...
        loading: false,
        "resources-refreshing": loading2.value,
        ...
        callout: withCtx(() => [
          showPrebuiltAgentsCallout.value ? (openBlock(), createBlock(unref(N8nCallout), {
            key: 0,
            theme: "secondary",
            icon: "bot",
            "icon-size": "large",
            ...
            _: 1
          }, 8, ["class"])) : showAIStarterCollectionCallout.value ? (openBlock(), createBlock(unref(N8nCallout), {
            key: 1,
            theme: "secondary",
            icon: "gift",
            class: normalizeClass(_ctx.$style["easy-ai-workflow-callout"])
          ...
          showReadyToRunWorkflowsCallout.value ? (openBlock(), createBlock(unref(N8nCallout), {
            key: 3,
            theme: "secondary",
            icon: "bolt-filled",
            class: normalizeClass(_ctx.$style["easy-ai-workflow-callout"])
        ...
        empty: withCtx(() => [
          unref(projectPages).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(_sfc_main$b, {
            key: 0,
            "personal-project": personalProject.value,
        ...
        postamble: withCtx(() => [
          workflowsAndFolders.value.length === 0 && !hasFilters.value ? (openBlock(), createElementBlock("div", {
            ...
            showArchivedOnlyHint.value ? (openBlock(), createBlock(unref(InfoTip), {
              key: 0,
              bold: false
            }, {
              default: withCtx(() => [
            ...
            unref(projectPages).isSharedSubPage && personalProject.value ? (openBlock(), createBlock(_sfc_main$b, {
              ...
              "personal-project": personalProject.value,
              "resource-type": "workflows"
            }, null, 8, ["personal-project"])) : currentFolder.value ? (openBlock(), createBlock(unref(N8nActionBox), {
              key: 2,
...
const actionsContainer = "_actionsContainer_6m3og_123";
const emptyStateCard = "_emptyStateCard_6m3og_139";
const emptyStateCardContent = "_emptyStateCardContent_6m3og_152";
const emptyStateCardIcon = "_emptyStateCardIcon_6m3og_159";
const dragging = "_dragging_6m3og_192";
const name = "_name_6m3og_210";
const style0 = {
  actionsContainer,
  "easy-ai-workflow-callout": "_easy-ai-workflow-callout_6m3og_128",
  "callout-trailing-content": "_callout-trailing-content_6m3og_133",
  emptyStateCard,
  emptyStateCardContent,
  emptyStateCardIcon,
  "add-folder-button": "_add-folder-button_6m3og_166",
  "breadcrumbs-container": "_breadcrumbs-container_6m3og_171",
  "breadcrumbs-loading": "_breadcrumbs-loading_6m3og_177",
  "empty-folder-container": "_empty-folder-container_6m3og_183",
  "drag-active": "_drag-active_6m3og_187",
  dragging,
  "drop-active": "_drop-active_6m3og_199",
  "path-separator": "_path-separator_6m3og_204",
  name,
  "pointer-disabled": "_pointer-disabled_6m3og_216"
};
const cssModules = {
  "$style": style0
};
