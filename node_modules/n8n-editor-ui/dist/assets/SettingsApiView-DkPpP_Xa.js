import { d as defineComponent, r as ref, e as createBlock, g as openBlock, k as unref, s as N8nCard, n as normalizeClass, w as withCtx, j as createBaseVNode, i as createVNode, ee as N8nActionToggle, h as createElementBlock, f as createCommentVNode, l as createTextVNode, t as toDisplayString, p as N8nText, c as useI18n, bd as DateTime, _ as _export_sfc, v as useSettingsStore, Q as useUIStore, b9 as useCloudPlanStore, a as useToast, ay as useDocumentTitle, aB as usePageRedirectionHelper, eu as useApiKeysStore, ev as storeToRefs, au as useRootStore, o as onMounted, ew as DOCS_DOMAIN, m as N8nHeading, ac as I18nT, F as Fragment, A as renderList, ex as ElCol, ey as ElRow, C as N8nLink, q as N8nButton, dW as N8nActionBox, am as useMessage, an as MODAL_CONFIRM, al as useTelemetry, ez as API_KEY_CREATE_OR_EDIT_MODAL_KEY } from "./index-C2iJCVYf.js";
...
const cardLink = "_cardLink_16gkp_123";
const cardHeading = "_cardHeading_16gkp_133";
const cardDescription = "_cardDescription_16gkp_140";
const cardActions = "_cardActions_16gkp_147";
const cardApiKey = "_cardApiKey_16gkp_156";
const style0$1 = {
  cardLink,
  cardHeading,
  cardDescription,
...
const ApiKeyCard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__cssModules", cssModules$1]]);
const _hoisted_1 = { style: { fontSize: "var(--font-size--sm)", color: "var(--color--text--tint-1)" } };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(isPublicApiEnabled) && unref(apiKeysSortByCreationDate).length ? (openBlock(), createElementBlock("div", {
          ...
          unref(isSwaggerUIEnabled) ? (openBlock(), createBlock(unref(N8nLink), {
            key: 0,
            ...
            _: 1
          }, 8, ["to"])) : (openBlock(), createBlock(unref(N8nLink), {
            key: 1,
        ...
        createBaseVNode("div", _hoisted_4, [
          unref(isPublicApiEnabled) && unref(apiKeysSortByCreationDate).length ? (openBlock(), createBlock(unref(N8nButton), {
            key: 0,
            size: "large",
        ...
        !unref(isPublicApiEnabled) && unref(cloudPlanStore).userIsTrialing ? (openBlock(), createBlock(unref(N8nActionBox), {
          key: 2,
        ...
        unref(isPublicApiEnabled) && !unref(apiKeysSortByCreationDate).length ? (openBlock(), createBlock(unref(N8nActionBox), {
          key: 3,
