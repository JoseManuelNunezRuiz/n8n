import { fc as makeRestApiRequest, d4 as useBuilderStore, a2 as useWorkflowsStore, Q as useUIStore, al as useTelemetry, fd as isPrebuiltAgentTemplateId, fe as isTutorialTemplateId, ff as parse, v as useSettingsStore, az as useWorkflowSaving, ak as WORKFLOW_SETTINGS_MODAL_KEY, ay as useDocumentTitle, a as useToast, aA as useWorkflowHelpers, fg as generateNodesGraph, c as useI18n, fh as getExecutionErrorToastConfiguration, ae as useNodeTypesStore, fi as getTriggerNodeServiceName, bG as useNodeHelpers, bs as useExternalHooks, fj as codeNodeEditorEventBus, fk as SampleTemplates, dg as EVALUATION_TRIGGER_NODE_TYPE, bH as useRunWorkflow, fl as getExecutionErrorMessage, fm as clearPopupWindowState, d1 as useCredentialsStore, fn as useAssistantStore, fo as isValidNodeConnectionType, fp as TRIMMED_TASK_DATA_CONNECTIONS_KEY, fq as useSchemaPreviewStore, fr as isCommunityPackageName, a0 as defineStore, au as useRootStore, a1 as usePushConnectionStore, bE as injectWorkflowState, r as ref } from "./index-C2iJCVYf.js";
...
function handleExecutionFinishedWithOther(workflowState, successToastAlreadyShown) {
  const workflowsStore = useWorkflowsStore();
  const toast = useToast();
  const i18n = useI18n();
