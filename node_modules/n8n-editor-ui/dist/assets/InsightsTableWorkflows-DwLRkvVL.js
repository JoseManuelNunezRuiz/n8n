const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CKH7O7yd.js","assets/index-C2iJCVYf.js","assets/index-BvbpnRSm.css","assets/InsightsPaywall-CE5W3W4m.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eg as mergeModels, x as computed, r as ref, c as useI18n, j4 as transformInsightsFailureRate, j5 as INSIGHTS_UNIT_MAPPING, j7 as transformInsightsTimeSaved, j8 as transformInsightsAverageRunTime, eh as useModel, a8 as watch, h as createElementBlock, g as openBlock, i as createVNode, w as withCtx, l as createTextVNode, t as toDisplayString, k as unref, m as N8nHeading, b_ as createSlots, j as createBaseVNode, n as normalizeClass, dm as defineAsyncComponent, e as createBlock, aa as N8nTooltip, F as Fragment, j9 as RouterLink, V as VIEWS, bu as resolveDynamicComponent, bS as normalizeProps, bT as guardReactiveProps, ei as N8nDataTableServer, aW as __vitePreload, al as useTelemetry, _ as _export_sfc } from "./index-C2iJCVYf.js";
import { s as smartDecimal } from "./InsightsSummary-ChZNMeJI.js";
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        createVNode(unref(N8nDataTableServer), {
          ...
          [`item.workflowName`]: withCtx(({ item }) => [
            (openBlock(), createBlock(resolveDynamicComponent(item.workflowId ? unref(RouterLink) : "div"), normalizeProps(guardReactiveProps(
              item.workflowId ? {
...
const ellipsis = "_ellipsis_z0cff_123";
const link = "_link_z0cff_132";
const blurryCover = "_blurryCover_z0cff_144";
const style0 = {
  ellipsis,
  link,
  blurryCover
